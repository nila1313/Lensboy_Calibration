...
def main():
    ...
    detections_path = output_folder / "detections" / "charuco_detections_clean_rms5.json"
    print("Using CLEAN detection file:", detections_path)
    ...
    debug_worst_folder = output_folder / "debug" / "worst_frames_clean_rms5"
    ...
    csv_path = reports_folder / "per_frame_reprojection_errors_clean_rms5.csv"
    ...
    worst_txt = reports_folder / "worst_frames_clean_rms5.txt"
    ...
    summary_path = reports_folder / "per_frame_error_summary_clean_rms5.json"
    with open(summary_path, "w") as f:
        json.dump(summary, f, indent=4)

    print("=" * 80)
    print("CLEAN PER-FRAME REPROJECTION EVALUATION")
    print("=" * 80)
